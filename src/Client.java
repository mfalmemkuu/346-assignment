    ...
    {   
    	...
    	/* Implement here the code for the run method ... */
    		if (this.clientOperation.equals("sending")) {
    				...
    				sendTransactions();
    				System.out.println("Terminating client sending thread - Running time 20 milliseconds");
    			
    		}
    		if (this.clientOperation.equals("receiving")) {
    			receiveTransactions(transact);
    			objNetwork.disconnect(objNetwork.getClientIP());
    			System.out.println("Terminating client recieving thread - Running time 20 milliseconds");
    		}
